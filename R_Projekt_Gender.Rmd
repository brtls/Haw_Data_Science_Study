...
häufigkeit der tweets zum Thema 
```{r}
...
netz %>% 
  ...
  geom_node_label(aes(label = Name, color = Partei), repel = T, show.legend = F, alpha = 0.5) +
  labs(title = "Retweet-Netzwerk deutscher Politiker*innen", size = "Anzahl Tweets")
```
FARBLEGENDE ÄNDERN, FARBEN ÄNDERN
